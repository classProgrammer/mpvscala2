...
import akka.actor.{Actor, ActorRef, PoisonPill, Props, Terminated, Scheduler}
...
class MainActor extends Actor {
  ...
  val consumer: ActorRef = context.actorOf(Props(new UnreliableConsumer(0.7f)), "MessageConsumer")
